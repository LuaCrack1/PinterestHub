...
ImageButton1.Image = "http://www.roblox.com/asset/?id=104576022705775"
...
local Library = Update:Window("MaruX Hub","",Enum.KeyCode.RightControl);

--local NguyenTien = Library:AddTab("Thông Báo","4483345998")
local Main = Library:AddTab("Chính","14355269935")
local M = Library:AddTab("Phụ Kiện","9606626859")
local Ss = Library:AddTab("Chỉ Số","14764174048")
local K = Library:AddTab("Sự Kiện","15679744806")
local RaceV4 = Library:AddTab("Tộc V4","11446900930")
local P = Library:AddTab("PVP","14764193934")
local R = Library:AddTab("Tập Kích","14764250087")
local T = Library:AddTab("Dịch Chuyển","14764218351")
...
while wait(.1) do
    if _G.FastAttack then
       ...
       Main:AddToggle("Dịch Chuyển Dạng Bypass",BypassTP,function(value)
        BypassTP = value
    end)
    
       Main:AddToggle("Bật Tộc V4",false,function(value)
       ...
       Main:AddToggle("Đặt Điểm Spawn",true,function(value)
    _G.Set = value
end)
...
Main:AddToggle("Đánh Nhanh ",true,function(value)
   ...
   Main:AddSeperator("Farm Level,...")
    ...
    Main:AddToggle("Cày Cấp",_G.AutoFarm,function(value)
        _G.AutoFarm = value
   ...
   Main:AddToggle("Cày Quái Xung Quanh",_G.AutoFarmNearest,function(value)
...
Main:AddToggle("Nhặt Rương | An Toàn ",false,function(value)
 AutoFarmChest = value
...
Main:AddToggle("Nhặt Rương Bypass | Bị Kick",false,function(vu)
	_G.ChestBypass = vu
end)
...
if _G.ChestBypass then
        ...
        while wait() do
            pcall(function()
                ...
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    ...
                    MobKilled:Set("✅ Boss Đang Spawn")
                end
            end)
        end
    end)

    Main:AddButton("Dịch Chuyển Đảo Bánh Bypass",function()
        if BypassTP then
    ...
    Main:AddToggle("Đánh Hoàng Tử Bột",_G.AutoDoughtBoss,function(value)
    ...
    Main:AddToggle("Triệu Hồi Hoàng Tử Bột",true,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Main:AddToggle("Đánh Vua Bột", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Main:AddToggle("Chuyển Server Đánh Vua Bột", _G.AutodoughkingHop,function(value)
...
Main:AddToggle("Đánh Boss",_G.AutoFarmBoss,function(value)
    ...
    Main:AddToggle("Nhiệm Vụ Boss(Beta)",false,function(value)
    _G.Auto_Quest_Boss = value
    end)
    
    Main:AddToggle("Chuyển Server Đánh Tất Cả Boss",_G.AutoAllBossHop,function(value)
...
spawn(function()
    ...
    Main:AddToggle("Đánh Nhanh [Siêu OP]",false,function(value)
       _G.HyperSonic = value
    end)      
...
Main:AddToggle("Xóa Chữ Thông Báo",false,function(NamfonGay)
...
Main:AddToggle("Xóa Âm Thanh Đánh Và Lên Level",false,function(Remo)
_G.RemoveHit = Remo
end)
...
spawn(function()
    ...
    Main:AddToggle("Xóa Đánh Quái",false,function(value)
    getgenv().A = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync 
getgenv().B = require(game.Players.LocalPlayer.PlayerScripts.CombatFramework.Particle).play
spawn(function()
...
elseif _G.WhiteScreen == false then
    ...
    Main:AddToggle("Tàng Hình Quái",_G.inv,function(value)
    _G.inv = value
    ...
    Main:AddLabel("Pos X Trước")
    Main:AddLabel("Pos Y Cao hoặc Thấp")
    Main:AddLabel("Góc Nhìn Z Sau")

    PosX = 1
    Main:AddSlider("Góc Nhìn X",0,50,1,function(value)
    PosX = value
    end)

    PosY = 30
    Main:AddSlider("Góc Nhìn Y",0,50,45,function(value)
    PosY = value
    end)

    PosZ = 10
    Main:AddSlider("Góc Nhìn Z",0,50,40,function(value)
    PosZ = value
    end)
...
do
    ...
    if World1 then
        M:AddToggle("Nhiệm Vụ Qua Biển 2",_G.AutoSecondSea,function(value)
    ...
    if World2 then
        ...
        M:AddToggle("Nhiệm Vụ Qua Biển 3",_G.AutoThirdSea,function(value)
    ...
    Mirragecheck:Set('🏝: Đảo Kì Bí Đang Spawn')
    else
...
M:AddToggle("Dịch Chuyển Đến Đảo Kì Bí",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            ...
            M:AddButton("Dịch Chuyển Đến Người Bán Fruits Nâng Cao", function()
                TweenNpc()
                end)
    ...
    M:AddToggle("Triệu Hồi Đảo Kì Bí",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
spawn(function()
    ...
    M:AddToggle("Lấy Thượng Nhân Quyền",_G.AutoSuperhuman,function(value)
    ...
    M:AddToggle("Lấy Tử Cước",_G.AutoDeathStep,function(value)
    ...
    M:AddToggle("Lấy Võ Cá Mập",_G.AutoSharkman,function(value)
    ...
    M:AddToggle("Lấy Lôi Trảo",_G.AutoElectricClaw,function(value)
    ...
    M:AddToggle("Lấy Long Trảo",_G.AutoDragonTalon,function(value)
    ...
    M:AddToggle("Lấy Thần Diệt Quyền",_G.Auto_God_Human,function(value)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							Title = "MaruX Thông Báo", 
							Text = "Chưa Có Thượng Nhân Quyền" ,
							Icon = "http://www.roblox.com/asset/?id=104576022705775",
							Duration = 2.5
						})
					end
...
M:AddToggle("Cày Nguyên Liệu Phóng Xạ",false,function(value)
Radioactive = value
...
M:AddToggle("Cày Răng Cà Rồng",false,function(value)
BjirVampire = value
...
spawn(function()
    ...
    M:AddToggle("Cày Vật Chất Kì Dị",_G.AutoEctoplasm,function(value)
    ...
    M:AddToggle("Cày Nước Mắt Huyền Bí",false,function(value)
_G.Makori_gay = value
...
spawn(function()
    ...
    M:AddToggle("Cày Quặng Nham Thạch",_G.Makori_gay,function(value)
_G.Umm = value
StopTween(_G.Umm)
end)
...
spawn(function()
    ...
    M:AddToggle("Cày Cánh Thiên Thần",_G.Makori_gay,function(value)
_G.Auto_Wing = value
...
spawn(function()
    ...
    M:AddToggle("Cày Da",_G.Makori_gay,function(value)
_G.Leather = value
...
spawn(function()
    ...
    M:AddToggle("Cày Sắt Vụn",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
spawn(function()
    ...
    M:AddToggle("Cày Bột Cocoa",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
spawn(function()
    ...
    M:AddToggle("Cày Vảy Rồng",false,function(value)
Dragon_Scale = value
...
spawn(function()
    ...
    M:AddToggle("Cày Thuốc Súng",false,function(value)
Gunpowder = value
StopTween(Gunpowder)
end)
...
spawn(function()
    ...
    M:AddToggle("Cày Đuôi Cá Biển 3",false,function(value)
Fish = value
StopTween(Fish)
end)
...
spawn(function()
    ...
    M:AddToggle("Cày Sừng Tê Giác",false,function(value)
MiniHee = value
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:AddToggle("Chuyển Server Để Cày",_G.Makori_gay,function(value)
    _G.StardHop = value
    end)
    
M:AddSeperator("Misc Mastery")
    
M:AddToggle("Cày Thông Thạo Trái",_G.AutoFarmFruitMastery,function(value)
...
spawn(function()
    ...
    M:AddToggle("Cày Thông Thạo Súng",_G.AutoFarmGunMastery,function(value)
    ...
    M:AddToggle("Lấy Kiếm Buddy",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    M:AddToggle("Chuyển Server Lấy Kiếm Buddy",_G.AutoBudySwordHop,function(value)
    ...
    M:AddToggle("Lấy Kiếm Oder", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    M:AddToggle("Chuyển Server Lấy Kiếm Oder", _G.AutoOderSwordHop,function(value)
    ...
    M:AddButton("Mua Microchip Oder",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    M:AddButton("Bắt Đầu Đi Đến Raid Oder",function()
        if World2 then
    ...
    M:AddToggle("Lấy Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
M:AddToggle("Chuyển Server Lấy Soul Guitar",false,function(value)
...
M:AddToggle("Lấy Song Kiếm",TestCDK,function(value)
TestCDK = value
...
M:AddToggle("Lấy Kiếm Tushita", _G.Autotushita,function(value)
         _G.Autotushita = value
        StopTween( _G.Autotushita)
    end)
    
    M:AddToggle("Chuyển Server Lấy Kiếm Tushita", _G.Autotushitahop,function(value)
    ...
    M:AddToggle("Lấy Kiếm Carvender", _G.AutoCarvender,function(value)
         _G.AutoCarvender = value
        StopTween( _G.AutoCarvender)
    end)
    
    M:AddToggle("Chuyển Server Lấy Kiếm Carvender", _G.AutoCarvenderhop,function(value)
    ...
    M:AddToggle("Đánh Hải Tặc", _G.AutoRaidPirate,function(value)
...
spawn(function()
    ...
    M:AddToggle("Lấy Twin Hook", _G.AutoTwinHook,function(value)
         _G.AutoTwinHook = value
        StopTween( _G.AutoTwinHook)
    end)
    
    M:AddToggle("Chuyển Server Lấy Twin Hook", _G.AutoTwinHook_Hop,function(value)
    ...
    M:AddToggle("Giết Boss Bí Ẩn",_G.AutoElitehunter,function(value)
    ...
    M:AddToggle("Chuyển Server Giết Boss Bí Ẩn",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    M:AddSeperator("Hallow Scythe")
    
    M:AddToggle("Lấy Lưỡi Hái Bóng Tối",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    M:AddToggle("Chuyển Server Lấy Lưỡi Hái Bóng Tối",_G.AutoFarmBossHallowHop,function(value)
    ...
    M:AddToggle("Giết Rip_indra",_G.AutoDarkDagger,function(value)
    ...
    M:AddToggle("Chuyển Server Giết Rip_indra",_G.AutoDarkDagger_Hop,function(value)
...
M:AddToggle("Triệu Hồi Rip_indra [ Cần Chén ]",false,function()
AutoHaki()
wait(0.5) 
local args = {
[1] = "activateColor",
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
	...
	M:AddToggle("Lấy Đinh Ba Rồng", _G.Auto_Dragon_Trident,function(value)
         _G.Auto_Dragon_Trident = value
        StopTween(_G.Auto_Dragon_Trident)
    end)
    
    M:AddToggle("Chuyển Server Lấy Đinh Ba Rồng", _G.Auto_Dragon_Trident_Hop,function(value)
	...
	M:AddToggle("Lấy Kiếm Warden", _G.Autowaden,function(value)
         _G.Autowaden = value
        StopTween( _G.Autowaden)
    end)
    
    M:AddToggle("Chuyển Server Lấy Kiếm Warden", _G.Autowadenhop,function(value)
    ...
    M:AddToggle("Chuyển Server Giết Râu Xám", _G.AutodoughkingHop,function(value)
         _G.Autogayhop = value
    end)
    ...
    M:AddToggle("Lấy Lôi Gậy V1", _G.Autodoughking,function(value)
         _G.Autopole = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Chuyển Server Lấy Lôi Gậy V1", _G.AutodoughkingHop,function(value)
    ...
    M:AddToggle("Lấy Kính Swan",_G.AutoFarmSwanGlasses,function(value)
    ...
    M:AddToggle("Chuyển Server Lấy Kính Swan",_G.AutoFarmSwanGlasses_Hop,function(value)
        _G.AutoFarmSwanGlasses_Hop = value
    end)
    
    M:AddSeperator("Sharks Saw")
    
    M:AddToggle("Lấy Cưa Cá Mập", _G.Autodoughking,function(value)
         _G.Autosaw = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Chuyển Server Lấy Cưa Cá Mập", _G.AutodoughkingHop,function(value)
         _G.Autosawhop = value
    end)
    ...
    BoneCheck = M:AddLabel("Xương Của Bạn: Third World ")
    ...
    local BoneFarm = M:AddToggle("Cày Xương",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    M:AddToggle("Quay Bất Ngờ",_G.Auto_Random_Bone,function(value)
    ...
    M:AddToggle("Cày Haki Quan Sát",_G.AutoObservation,function(value)
    ...
    M:AddToggle("Chuyển Server Cày Haki Quan Sát",_G.AutoObservation_Hop,function(value)
    ...
    M:AddToggle("Lấy Saber",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
			
			M:AddToggle("Chuyển Server Lấy Saber",_G.AutoSaberHop,function(value)
 ...
 spawn(function()
    ...
    M:AddToggle("Chuyển Server Mua Kiếm Huyền Thoại",_G.AutoBuyLegendarySword_Hop,function(value)
    ...
    M:AddToggle("Chuyển Server Mua Haki Màu",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    M:AddToggle("Mua Mũ Kiếm Sĩ",_G.AutoMusketeerHat,function(value)
    ...
    M:AddToggle("Lấy Haki Cầu Vồng",_G.Auto_Rainbow_Haki,function(value)
    ...
    M:AddToggle("Tự Động Làm Nhiệm Vụ Citizen",_G.AutoObservationHakiV2,function(x)
    ...
    M:AddToggle("Lấy Rengoku",_G.AutoRengoku,function(value)
    ...
    M:AddToggle("Lấy Yama",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    M:AddToggle("Tự Động Làm Nhiệm Vụ V2",_G.Auto_EvoRace,function(value)
    ...
    M:AddToggle("Tự Động Làm Nhiệm Vụ Bartilo",_G.AutoBartilo,function(value)
    ...
    M:AddToggle("Tự Động Thắp Đuốc",_G.AutoHolyTorch,function(value)
...
Ss:AddToggle("Tự Động Nâng Chỉ Số Kaitun",_G.Auto_Stats_Kaitun,function(value)
...
Ss:AddToggle("Trái Ác Quỷ",false,function(value)
demonfruit = value
end)
...
K:AddToggle("Triệu Hồi Đảo Kitsune [Trăng Tròn]",false,function(vu)
    _G.SummonKitsune = vu
...
spawn(function()
    while wait() do
        if _G.SummonKitsune then
            pcall(function()
                if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=104576022705775" then
...
K:AddToggle("Dịch Chuyển Đến Đảo Kitsune",false,function(vu)
    _G.Kitsune = vu
...
K:AddToggle("Chuyển Server Đảo Kitsune",false,function(vu)
    _G.KitsuneHop = vu
end)
...
K:AddToggle("Tự Động Nhặt Azure Ember",false,function(vu)
    _G.AzureKitsune = vu
...
K:AddToggle("Tự Động Trao Đổi Azure Ember",_G.TradeItem,function(state)
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') then
                FrozenIsland:Set('Đảo Leviathan : ✅')
            else
                FrozenIsland:Set('Đảo Leviathan : ❌')
            end
        end
...
K:AddToggle('Đảo Leviathan [ Phải Spawn ]', false, function(value)
...
K:AddToggle('Tự Động Đánh Thủy Quái', false, function(value)
...
K:AddToggle('Tự Động Đánh PirateBrigade', _G.bjirPirateBrigade, function(value)
...
K:AddToggle('Tự Động Đánh GhostShip', _G.bjirFishBoat, function(value)
...
K:AddToggle("Tự Động Đánh Terrorshark",_G.Makori_gay,function(value)
...
K:AddToggle("Tự Động Đánh Shark",_G.Makori_gay,function(value)
_G.bjirShark = value
...
K:AddToggle("Tự Động Đánh Piranha",_G.Makori_gay,function(value)
...
--[[
K:AddToggle('Tự Động Lấy Anchor [Đủ Nguyên Liệu]', _G.BjirAnchorCuy, function(state)
local function findItem(name, amount)
    for _, item in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventory")) do
        if item["Type"] == "Material" and item["Name"] == name and item["Count"] >= amount then
            return true
...
K:AddToggle("Tự Động Lái Thuyền Ra Biển Động",_G.AutoRemover,function(state)
if state then
    _G.AutoRemover = true
else
...
RaceV4:AddLabel("Làm Ơn Đến Biển 3 😑")
end

if World3 then
    RaceV4:AddSeperator("Race V4")
    
RaceV4:AddButton("Dịch Chuyển Đến Đỉnh Cây",function()
  HyperCahaya(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
    end)
    
    RaceV4:AddButton("Dịch Chuyển Đến Đền Thờ Thời Gian",function()
...
RaceV4:AddButton("Dịch Chuyển Đến Acient One (Bạn Phải Trong Đền!)",function()
  HyperCahaya(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   
   RaceV4:AddButton("Mở Khóa Cần Gạt", function()
...
RaceV4:AddToggle("Tự Động Mua Bánh Răng",_G.Auto_Farm_Bone4,function(value)
...
RaceV4:AddToggle("Tắt Cầu Thang Vô Hạn", nil, function(value)
	game.Players.LocalPlayer.Character.InfiniteStairs.Disabled = value
end)

 
  RaceV4:AddButton("Dịch Chuyển Cửa Tộc Của Bạn",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
  ...
  RaceV4:AddToggle("Thử Nghiệm Tất Cả Tộc V4",false,function(v)
  _G.AutoQuestRace = v
...
RaceV4:AddToggle("Tự Động Khóa Trăng",_G.LockCamToMoon,function(value)
...
RaceV4:AddToggle("Giết Người Chơi Sau Thử Nghiệm!",false,function(value)
...
spawn(function()
  ...
  RaceV4:AddButton("Mua Nhiệm Vụ Ancient One",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
    ...
    P:AddToggle("Săn Người Chơi",false,function(value)
...
spawn(function()
    ...
    P:AddToggle("Aimbot Kĩ Năng",false,function(value)
    ...
    local TimeRaid = R:AddLabel("Chờ Tập Kích")
...
spawn(function()
    ...
    Island5:Set('✅ : Đảo 5')
      ...
      Island5:Set('❌ : Đảo 5' )end
        ...
        R:AddToggle("Chọn Đảo",_G.Auto_Dungeon,function(value)
...
spawn(function()
    ...
    R:AddToggle("Giết Quái Xung Quanh",_G.concubu ,function(vu)
    _G.concubu  = vu
    end)
...
spawn(function()
    ...
    R:AddToggle("Chọn Tập Kích",_G.AutoSelectDungeon,function(value)
    ...
    R:AddButton("Chọn Để Mua Chip",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    R:AddToggle("Tự Động Bắt Đầu Tập Kích",_G.Auto_StartRaid,function(value)
    ...
    R:AddButton("Bắt Đầu Tập Kích",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
        ...
        R:AddButton("Qua Đảo Tiếp Theo",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
                HyperCahaya(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame*CFrame.new(0,70,100))
            elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
    ...
    if World2 then
        R:AddButton("Dịch Chuyển Đến Phòng Thí Nghiệm",function()
 ...
 R:AddToggle("Tự Động Lấy Kiếm Law", _G.AutoOderSword,function(value)
     _G.AutoOderSword = value
    StopTween( _G.AutoOderSword)
    end)
    
    R:AddToggle("Chuyển Server Lấy Kiếm Law", _G.AutoOderSwordHop,function(value)
         _G.AutoOderSwordHop = value
    end)
    ...
    R:AddButton("Mua Microchip Law Boss",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    R:AddButton("Bắt Đầu Đi Đến Raid Law Boss",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)
    ...
    T:AddButton("Dịch Chuyển Đến Biển 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:AddButton("Dịch Chuyển Đến Biển 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:AddButton("Dịch Chuyển Đến Biển 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:AddButton("Dịch Chuyển Đến Thủy Quái",function()
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
    ...
    T:AddButton("Dịch Chuyển Dạng Bypass",function()
...
S:AddButton("Buy Sword",function()
    ...
    S:AddButton("Quay Bất Ngờ [ $50 Bone ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,1)
    end)
...
S:AddButton("Quay Tộc (Use 3K Fragments)", function()
...
D:AddSeperator("Sniper")
    ...
    _G.SelectFruit = ""
    D:AddDropdown("Chọn Ngắm Trái",Table_DevilFruitSniper,function(value)
        _G.SelectFruit = value
    end)
    
    D:AddToggle("Tự Động Ngắm Mua Trái",_G.AutoBuyFruitSniper,function(value)
        _G.AutoBuyFruitSniper = value
    end)
    
        D:AddButton("Kiểm Tra Stock Đảo Kì Bí",function()
...
closeButton.MouseButton1Click:Connect(closeGUI)
    ...
    D:AddButton("Kiểm Tra Stock Thường",function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = ReplicatedStorage.Remotes
...
closeButton.MouseButton1Click:Connect(closeGUI)
    ...
    D:AddDropdown("Chọn Trái Để Ăn",Table_DevilFruitSniper,function(value)
        _G.SelectFruitEat = value
    end)
    
    D:AddToggle("Tự Động Ăn Trái",_G.AutoEatFruit,function(value)
    ...
    D:AddToggle("Chuyển Server Ăn Trái",_G.AutoEatFruitHop,function(value)
    ...
    D:AddToggle("Tự Động Quay Trái",_G.Random_Auto,function(value)
    ...
    D:AddButton("Quay Trái",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
    
        D:AddButton("Mở Cửa Hàng Trái",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    D:AddToggle("Tự Động Thả Trái",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    D:AddToggle("Tự Động Lưu Trái",_G.AutoStoreFruit,function(value)
...
spawn(function()
    ...
    D:AddToggle("Lấy Trái Nhanh",_G.Grabfruit,function(value)
    _G.Grabfruit = value
    end)
    spawn(function()
			while wait(.1) do
    ...
    D:AddToggle("Dịch Chuyển Đến Trái",_G.Tweenfruit,function(value)
    _G.Tweenfruit = value
    ...
    spawn(function()
        ...
        D:AddToggle("Lấy Trái Nhanh 75% Hệ Thống Kick",_G.BringFruitBF,function(value)
    ...
    Misc:AddButton("Chuyển Server",function()
        Hop()
    end)
    
    Misc:AddButton("Chuyển Server Ít Người",function()
    ...
    Misc:AddButton("Sao Chép Job Id",function()
	setclipboard(tostring(game.JobId))
	end)
	
    Misc:AddTextbox("Địa điểm Job Id", true, function(value)
	_G.Job = value
	end)

	Misc:AddButton("Tham Gia Server [Beta]",function()
	game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
	end)
	
    Misc:AddSeperator("Misc")
    
    Misc:AddButton("Mở Cửa Hàng Trái",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    ...
    Misc:AddButton("Mở Kho Trái",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true
    end)
    
    Misc:AddButton("Tên Thành Tựu",function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:AddButton("Màu Haki",function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)
      
Misc:AddSeperator("Teams")
    
    Misc:AddButton("Tham Gia Nhóm Hải Tặc",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Misc:AddButton("Tham Gia Nhóm Hải Quân",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
    Misc:AddSeperator("Highlight")

Misc:AddToggle("Tắt Hiện Tin Nhắn", _G.chat, function(value)
    _G.chat = value
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  Misc:AddToggle("Tắt Hiện Bảng Xếp Hạng", _G.leaderboard, function(a)
    _G.leaderboard = a
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    Misc:AddToggle("Chế Độ Hightlight",false,function(value)
        if value == true then
...
Misc:AddToggle("Đồ Họa",false,function(v)
			if v then
	...
	Misc:AddToggle("Haki Cầu Vồng",false,function(value)
		RainbowHaki = value
	end)

	Misc:AddToggle("Yoru Cầu Vồng",false,function(value)
		RainbowYoru = value
	end)
    ...
    Misc:AddSeperator("Khác")

Misc:AddToggle("Chống AFK", true, function()
...
repeat wait() until game:IsLoaded() 
	...
	Misc:AddToggle("Tự Động Vào Lại",true,function(value)
		_G.AutoRejoin = value
	end)
	...
	Misc:AddTextbox("Khóa Tiền", "Nhập Số", true, function(value)
	_G.LockBeli = value
	end)
	
	Misc:AddTextbox("Khóa Fragment", "Nhập Số", true, function(value)
	_G.LockFragments = value
	end)
	
    Misc:AddSeperator("Hack")
    Misc:AddButton("Mở Khóa Cường Hóa",function()
...
elseif type(Ability) == 'table' then
   ...
   Misc:AddButton("Mở Khóa Tốc Biến",function()
   -- Ability [
--     Buso,Soru,Geppo-- ]
--Example
...
elseif type(Ability) == 'table' then
   ...
   Misc:AddButton("Mở Khóa Nhảy Trên Không",function()
-- Ability [
--     Buso,Soru,Geppo-- ]
--Example
...
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
    ...
    Misc:AddButton("Mở Khóa Cổng",function()
    ...
    Misc:AddButton("Phóng Tối Đa", function()
		while wait() do
			game.Players.LocalPlayer.CameraMaxZoomDistance = 9223372036854718
			end
	end)

Misc:AddButton("Hiện Tất Cả Đồ", function(value)
    ...
    Misc:AddButton("Tàng Hình",function()
        game:GetService("Players").LocalPlayer.Character.LowerTorso:Destroy()
    end)
    
    Misc:AddButton("Nhấp Dụng Cụ TP",function()
    ...
    Misc:AddButton("Dừng Tất Cả Dịch Chuyển",function()
        HyperCahaya(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
        _G.Clip = false
    end)
    ...
    Misc:AddButton("Nhập Tất Cả Code",function()
    ...
    Misc:AddDropdown("Chọn Code Reset Stats",{"NOOB_REFUND","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(value)
        _G.CodeSelect = value
    end)
    
    Misc:AddButton("Nhập Code (Chọn Code)",function()
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
    end)
    
    Misc:AddSeperator("State")
    
    Misc:AddDropdown("Chọn Cấp Độ Haki",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
        _G.SelectStateHaki = value
    end)
    
    Misc:AddButton("Thay Đổi Cấp Độ Haki",function()
    ...
    Misc:AddButton("Xóa Sương Mù",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)
    
    Misc:AddButton("Bầu Trời Luôn Sáng",function()
    game:GetService("RunService").Heartbeat:wait() do
        game:GetService("Lighting").ClockTime = 12
    end
    end)
    
    Misc:AddToggle("Xóa Sát Thương",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
    ...
    Misc:AddButton("Mở Khóa FPS",function()
        setfpscap(9999999)
    end)
    
    Misc:AddButton("Giảm Bớt Cpu", function()
...
Misc:AddToggle("Esp Quái", false, function(nec)
    ...
    Misc:AddToggle("Không có thời gian hồi chiêu",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
